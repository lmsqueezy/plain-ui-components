...
class Text implements ContainerComponent, RowComponent
{
    /**
    ...
    /**
     * Create a new text component instance.
     */
    ...
    /**
     * Fluently create a new text component instance.
     */
    ...
    public function toArray(): array
    {
        return [
            'componentText' => [
                ...($this->size !== TextSize::M ? ['textSize' => $this->size->value] : []),
                ...($this->color !== TextColor::NORMAL ? ['textColor' => $this->color->value] : []),
                'text' => $this->text,
            ],
        ];
    }
